...
class DCGAN(object):
    ...
    def discriminator(self):
        ...
        depth = 64
        dropout = 0.4
        # In: 28 x 28 x 1, depth = 1    卷积核的输入通道数
        # Out: 14 x 14 x 1, depth=64    卷积核的输出通道数
    ...
    def discriminator_model(self):
        ...
        #optimizer = RMSprop(lr=0.0002, decay=6e-8)  # 论文中使用的好像是adam
...
if __name__ == '__main__':
    ...
    mnist_dcgan.train(train_steps=501, batch_size=256, save_interval=500)
